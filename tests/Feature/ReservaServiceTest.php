...
class ReservaServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        ParametroSistema::create([
            ...
            'tipo_dato' => 'ENTERO',
            'valor' => '7',
            'descripcion' => 'Configuración para pruebas.',
            'editable' => true,
            'activo' => true,
    ...
    public function test_crea_reserva_y_cambia_equipo_a_reservado(): void
    {
        ...
        $servicio = app(ReservaService::class);
        ...
        $reserva = $servicio->crearReserva(
            ...
            observacion: 'Reserva creada desde prueba automatizada.'
        );
        ...
        $this->assertDatabaseHas('detalles_reservas', [
            'reserva_id' => $reserva->id,
            'equipo_id' => $equipo->id,
            'precio_acordado' => '3500.00',
            'descuento_acordado' => '0.00',
        ]);
    ...
    public function test_no_permite_reserva_mayor_al_plazo_estandar(): void
    {
        ...
        $servicio->crearReserva(
            ...
            usuarioId: $this->usuario->id,
            equiposIds: [$equipo->id],
            fechaVencimiento: now()->addDays(8)
        );
    }

    public function test_si_falla_un_equipo_se_revierte_toda_la_reserva(): void
    {
        $equipoDisponible = $this->crearEquipoDisponible();
        $equipoNoDisponible = $this->crearEquipoDisponible();
