...
class IntervencionUnidadAdquiridaService
{
        ...
        return DB::transaction(
            function () use (
                ...
                */
                ...
                |--------------------------------------------------------------------------
                |
                | Una intervención con componente significa que la unidad
                | continúa dentro de la etapa de preparación.
                |
                | No marcamos requiere_servicio porque el componente
                | ya fue adquirido e incorporado.
                |
                */
        ...
        return DB::transaction(
            function () use (
                ...
                */
                ...
                |--------------------------------------------------------------------------
                |
                | Mientras exista una preparación/servicio pendiente,
                | la unidad no debe mostrarse automáticamente como
                | lista para despacho.
                |
                | Una revisión preliminar posterior confirmará
                | si ya está funcional y lista para envío.
                |
                */
        ...
        return DB::transaction(
            function () use (
                ...
                */
                ...
                |--------------------------------------------------------------------------
                |
                | También bloqueamos el producto para evitar operar
                | sobre un producto desactivado concurrentemente.
                |
                */
                ...
                /*
                 * Las existencias cuantitativas corresponden
                 * solamente a productos no serializados.
                 */
                ...
                */
                ...
                |--------------------------------------------------------------------------
                |
                | Inicialmente no tiene movimiento de inventario.
                | Si algo falla posteriormente, toda la transacción
                | será revertida.
                |
                */
                ...
                $intervencion =
                    IntervencionUnidadAdquirida::create([
                        ...
                        /*
                         * Por ahora no se inventa una valoración.
                         *
                         * existencias_productos solamente almacena
                         * cantidades y no costo promedio/FIFO.
                         */
                        'tipo_costo_id' =>
                            null,
                ...
                */
                ...
                |--------------------------------------------------------------------------
                |
                | Aunque el componente provenga del stock de OneShop,
                | la unidad continúa dentro de la etapa de preparación.
                |
                | No marcamos requiere_servicio porque la intervención
                | ya se realizó correctamente.
                |
                */
    ...
    /**
     * Resuelve moneda, tipo de cambio histórico
     * y equivalente en bolivianos.
     *
    ...
    /**
     * Obtiene una unidad que todavía pueda gestionarse
     * dentro de la etapa previa al inventario.
     */
...
if (
    ...
    throw new ReglaNegocioException(
        'La unidad no se encuentra en una etapa válida para registrar intervenciones.'
    );
        }
    ...
    /**
     * Valida que el usuario pueda gestionar importaciones.
     */
